...
data = np.array([88,161,154,194,216,245,293,347,238,74])
date = ['2016-01','2016-02','2016-03','2016-04','2016-05','2016-06','2016-07','2016-08','2016-09','2016-10']
...
class C():
    ...
    def plot(self, ax):
        for i in range(self.N):
            circ = plt.Circle(self.x[i,:2],self.x[i,2],label=date[i]+' cases: '+str(data[i]),color=np.random.rand(3,))
            ax.add_patch(circ)
...
ax.set_title('Zika cases during months')
plt.show()
